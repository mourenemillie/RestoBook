...
<div class="app-wrapper">
    ...
    <main class="main-content">
        <div class="page-header">
            ...
            <button class="btn-add"><i class="bi bi-plus-lg"></i> Tambah Meja</button>
        </div>

        <!-- STATS -->
        <div class="stats-grid">
            <div class="stat-card">
                <span>Total Meja</span><h2>24</h2>
                <div class="stat-icon-bg" style="background: #FBEAE9;"><i class="bi bi-door-open"></i></div>
            </div>
            <div class="stat-card">
                <span>Tersedia</span><h2 style="color: var(--green);">12</h2>
                <div class="stat-icon-bg" style="background: #D1FAE5;"><i class="bi bi-check-circle"></i></div>
            </div>
            <div class="stat-card">
                <span>Terisi</span><h2 style="color: var(--red);">8</h2>
                <div class="stat-icon-bg" style="background: #FEE2E2;"><i class="bi bi-people"></i></div>
            </div>
            <div class="stat-card">
                <span>Direservasi</span><h2 style="color: var(--yellow);">4</h2>
                <div class="stat-icon-bg" style="background: #FEF3C7;"><i class="bi bi-clock"></i></div>
            </div>
        </div>
        ...
        <div class="denah-section">
            ...
            <div class="table-grid">
                <!-- Meja 01 -->
                <div class="meja-card tersedia">
                    <span class="meja-id">01</span>
                    <div class="status-pill pill-tersedia">Tersedia</div>
                    <div class="meja-info"><i class="bi bi-people"></i> 4 Kursi</div>
                </div>
                <!-- Meja 02 -->
                <div class="meja-card terisi">
                    <span class="meja-id">02</span>
                    <div class="status-pill pill-terisi">Terisi</div>
                    <div class="meja-info"><i class="bi bi-clock"></i> 45 Min</div>
                </div>
                <!-- Meja 03 -->
                <div class="meja-card direservasi">
                    <span class="meja-id">03</span>
                    <div class="status-pill pill-direservasi">Direservasi</div>
                    <div class="meja-info" style="font-size: 10px;">
                        <i class="bi bi-clock"></i> 19:00 - Bpk. Andi
                    </div>
                </div>
                <!-- Meja 04 Wide -->
                <div class="meja-card tersedia wide">
                    <div>
                        <span class="meja-id">04</span>
                        <div class="status-pill pill-tersedia">Tersedia</div>
                    </div>
                    <div class="meja-info"><i class="bi bi-people"></i> 8 Kursi (Keluarga)</div>
                </div>
                <!-- Meja 05 -->
                <div class="meja-card tersedia">
                    <span class="meja-id">05</span>
                    <div class="status-pill pill-tersedia">Tersedia</div>
                    <div class="meja-info"><i class="bi bi-people"></i> 2 Kursi</div>
                </div>
                <!-- Meja 06 -->
                <div class="meja-card terisi">
                    <span class="meja-id">06</span>
                    <div class="status-pill pill-terisi">Terisi</div>
                    <div class="meja-info"><i class="bi bi-clock"></i> 15 Min</div>
                </div>
            </div>
        </div>
    </main>
