...
<option value="Dessert" {{ old('category', $menu->category) == 'Dessert' ? 'selected' : '' }}>🍰 Dessert</option>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" class="form-control"
                                  placeholder="Jelaskan bahan, rasa, atau keunikan menu ini...">{{ old('description', $menu->description) }}</textarea>
                    </div>
    ...
    <img
        ...
        alt="{{ $menu->name }}"
        style="width:100%;max-height:220px;object-fit:cover;border-radius:16px;margin-bottom:15px;">
@endif
