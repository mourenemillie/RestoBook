...
<div class="bg-[#fafafa] min-h-screen py-16 flex items-center font-['Plus_Jakarta_Sans',sans-serif]">
    <div class="container mx-auto px-6 max-w-2xl text-center">
        ...
        <div class="inline-flex items-center justify-center w-24 h-24 bg-emerald-50 rounded-[2rem] text-emerald-500 mb-8 shadow-sm border border-emerald-100">
        ...
        <div id="printable-ticket" class="bg-white p-8 rounded-[2.5rem] shadow-sm border border-gray-100 text-left mb-10 relative overflow-hidden">
            ...
            <div class="flex justify-between items-center pb-6 border-b border-gray-50 mb-6">
                <div>
                    ...
                    <p class="text-xl font-black text-orange-600 tracking-wide mt-0.5">{{ $booking->booking_code }}</p>
                </div>
                <div class="bg-emerald-50 text-emerald-700 px-4 py-2 rounded-xl text-xs font-extrabold uppercase">
                    Status: Lunas
                </div>
            </div>
