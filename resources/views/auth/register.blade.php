...
@section('content')
    ...
    <form action="/register" method="POST">
        ...
        <div class="fields-grid">
            ...
            <div class="field-group full-width owner-field" style="display: {{ old('role') === 'owner' ? 'block' : 'none' }};">
            ...
            <div class="field-group full-width owner-field" style="display: {{ old('role') === 'owner' ? 'block' : 'none' }};">
                ...
                <input id="location" type="text" name="location" placeholder="Kota atau Alamat lengkap" value="{{ old('location') }}">
            </div>
